...
- **State Management**: This `GEMINI.md` file is read *once* at the start of a session. It does not provide dynamic configuration. All state changes must be managed actively with tools.
